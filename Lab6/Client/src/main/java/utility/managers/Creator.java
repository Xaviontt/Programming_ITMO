...
public class Creator {
    ...
    public StudyGroup create(int id){
        return new StudyGroup(id, newStudyGroup(), newCoordinates(), LocalDate.now(), newStudentsCount(), newExpelledStudents(), newAverageMark(), newSemester(), newGroupAdmin());
    }
    ...
    public Semester newSemester() {
        String sem = Stream.of(Semester.values())
                .map(Enum::name)
